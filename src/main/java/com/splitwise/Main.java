...
public class Main implements CommandLineRunner {
    ...
    final AuthenticationCommandHandler authenticationCommandHandler;
    ...
    public Main(final AuthenticationCommandHandler authenticationCommandHandler,
                final RegisterCommand registerCommand,
                final AddGroupCommand addGroupCommand,
                final ExitCommand exitCommand){
    ...
    public void run(String... args)throws  IOException{
        ...
        authenticationCommandHandler.registerCommand(addGroupCommand);
